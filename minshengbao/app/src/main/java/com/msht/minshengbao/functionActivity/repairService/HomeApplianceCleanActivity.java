 ...
 * @date 2017/6/16  
 */
public class HomeApplianceCleanActivity extends BaseActivity {
    ...
    private static class RequestHandler extends Handler{
        private WeakReference<HomeApplianceCleanActivity> mWeakReference;
        private RequestHandler(HomeApplianceCleanActivity activity) {
            mWeakReference = new WeakReference<HomeApplianceCleanActivity>(activity);
        }
        @Override
        public void handleMessage(Message msg) {
            final HomeApplianceCleanActivity activity=mWeakReference.get();
