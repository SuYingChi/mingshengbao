...
public class MyorderworkDetail extends BaseActivity implements View.OnClickListener {
    ...
    private RelativeLayout   Rexpense,Rvoucher,Rpayfee;
    private RelativeLayout   Repair_cancel,Rforwars,Rphone;
    ...
    private JSONArray jsondicount;//数据解析
        ...
        switch (requestCode){
            case EVA_CODE:
                if (resultCode==2){      //评价成功
                    ...
                    couponamount=Double.parseDouble(diamount);   //String转化成double
    ...
    private void initfindview() {
        ...
        masterphoneimg=(ImageView)findViewById(R.id.id_img4) ;
        ...
        Rpayfee=(RelativeLayout)findViewById(R.id.id_re_pay);
        Rvoucher=(RelativeLayout)findViewById(R.id.id_re_voucher);
        Rexpense=(RelativeLayout)findViewById(R.id.id_re_expanse);
        Rphone=(RelativeLayout)findViewById(R.id.id_re_phone);
        Repair_cancel=(RelativeLayout)findViewById(R.id.id_relayout_cancel);
        Rmaster=findViewById(R.id.id_master_info);
        Rforwars=(RelativeLayout)findViewById(R.id.id_relauout_master);
        ...
        findViewById(R.id.id_btn_refix).setOnClickListener(this);
        findViewById(R.id.id_btn_refund).setOnClickListener(this);
    }
    ...
    private void initEvent() {
        masterphoneimg.setOnClickListener(this);
