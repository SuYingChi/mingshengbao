package com.msht.minshengbao.ViewUI.ButtonUI;
...
public class ButtonExtendM extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a != null) {
            ...
            float textSize=a.getDimensionPixelOffset(R.styleable.menuItemM_textSize, 16);
            if (textSize != 0) {
                tvContent.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
            }
            //设置两个控件之间的间距
            spacing = a.getDimensionPixelSize(R.styleable.buttonExtendM_spacing, ConvertUtil.dp2px(context, 8));
            //设置两个控件的位置结构
    ...
    public void setSpacing(int spacing) {
        this.spacing = ConvertUtil.dp2px(mContext, spacing);
