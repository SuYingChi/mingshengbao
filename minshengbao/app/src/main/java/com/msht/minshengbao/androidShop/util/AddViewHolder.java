...
public class AddViewHolder {
    ...
    public AddViewHolder setImage(int viewId, String url) {
        ...
        GlideUtil.loadRemoteImg(context, view, url);
        return this;
    }
    public AddViewHolder setImageUseFitWidth(int viewId, String url) {
        ImageView view = getView(viewId);
        GlideUtil.loadByWidthFitHeight(context, view, url);
        return this;
    }
    ...
    public AddViewHolder setBackgroundResouce(int viewId, int resId) {
        View view = getView(viewId);
