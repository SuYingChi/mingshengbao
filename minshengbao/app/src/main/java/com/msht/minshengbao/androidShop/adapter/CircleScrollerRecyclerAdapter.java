 ...
 */
public abstract class CircleScrollerRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerHolder> {
    ...
    public CircleScrollerRecyclerAdapter(Context context) {
        this.context = context;
        this.monetary_unit = context.getResources().getString(R.string.monetary_unit);
    }

    public CircleScrollerRecyclerAdapter(Context context, int layoutId) {
        this.context = context;
        this.layoutId = layoutId;
        this.monetary_unit = context.getResources().getString(R.string.monetary_unit);
    }

    public CircleScrollerRecyclerAdapter(Context context, int layoutId, List<T> datas) {
        this.context = context;
        this.layoutId = layoutId;
        this.datas = datas;
        this.monetary_unit = context.getResources().getString(R.string.monetary_unit);
