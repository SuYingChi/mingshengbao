package com.msht.minshengbao.custom.Circular;
...
public class HoverImageView extends AppCompatImageView {
	...
	private void setup(AttributeSet attrs) {
		if(attrs != null){
			TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.RoundImageViews);
			borderColor = typedArray.getColor(R.styleable.RoundImageViews_borderColor, borderColor);
			hoverColor = typedArray.getColor(R.styleable.RoundImageViews_hoverColor, hoverColor);
			borderWidth = typedArray.getDimension(R.styleable.RoundImageViews_borderWidths, borderWidth);
			typedArray.recycle();
		}
