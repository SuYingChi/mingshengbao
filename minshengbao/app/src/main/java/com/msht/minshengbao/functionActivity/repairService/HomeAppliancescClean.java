...
import com.msht.minshengbao.adapter.HomeApplianceiAdapter;
...
public class HomeAppliancescClean extends BaseActivity {
    private WebView webView;
    private MyNoScrollGridView mGridView;
    private HomeApplianceiAdapter homeAdapter;
    private String pid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        homeAdapter=new HomeApplianceiAdapter(context,functionList);
