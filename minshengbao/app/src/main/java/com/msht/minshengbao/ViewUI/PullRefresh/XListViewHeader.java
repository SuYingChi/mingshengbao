 ...
 */
package com.msht.minshengbao.ViewUI.PullRefresh;
...
public class XListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mResultImageView=(ImageView)findViewById(R.id.id_result_img);
...
//        refreshUpdatedAtValue();
        ...
        if (state == STATE_REFRESHING) {    // 显示进度
            ...
            mResultImageView.setVisibility(INVISIBLE);
        } else {    // 显示箭头图片
        ...
        switch (state) {
            ...
            case STATE_SUCCESS:
                ...
                mResultImageView.setImageResource(R.drawable.load_succeed);
            ...
            case STATE_FRESH_FAILT:
                ...
                mResultImageView.setVisibility(VISIBLE);
                mResultImageView.setImageResource(R.drawable.load_failed);
                mArrowImageView.setVisibility(INVISIBLE);
