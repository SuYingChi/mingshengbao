 ...
 * @date 2017/6/7  
 */
public class SanitaryWareActivity extends BaseActivity {
    ...
    private static class RequestHandler extends Handler{
        private WeakReference<SanitaryWareActivity> mWeakReference;
        private RequestHandler(SanitaryWareActivity activity) {
            mWeakReference = new WeakReference<SanitaryWareActivity>(activity);
        }
        @Override
        public void handleMessage(Message msg) {
            final SanitaryWareActivity activity=mWeakReference.get();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanitary_ware);
        setCommonHeader("洁具卫浴");
        context=this;
