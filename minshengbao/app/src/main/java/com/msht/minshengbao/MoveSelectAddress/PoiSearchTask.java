...
public class PoiSearchTask implements PoiSearch.OnPoiSearchListener{
    ...
    private MoveSelectAddress.PoiAdapter mAdapter;
    ...
    public PoiSearchTask setAdapter(MoveSelectAddress.PoiAdapter adapter){
    ...
    public void onSearch(String key, String city,double lat,double lng){
        ...
        mSearch.setBound(new PoiSearch.SearchBound(new LatLonPoint(lat, lng), 500));//设置周边搜索的中心点以及半径
        //设置异步监听
        ...
        if(rCode == 1000) {
            if (poiResult != null && poiResult.getQuery() != null) {
                ...
                for (PoiItem item : items) {
                    ...
                    datas.add(new LocationBean(lon, lat, title, mContent));
                }
