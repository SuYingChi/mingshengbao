...
public class NewShopCarFragment extends ShopBaseLazyFragment implements NewCarListAdapter.CarListListener, OnRefreshListener, ICarListView {
    ...
    private ShopCarFragment.CarParentListener carParentListener;
    ...
    public void onAttach(Context context) {
        ...
        carParentListener = (ShopCarFragment.CarParentListener) getParentFragment();
    }
    ...
    public void onGetCarListSuccess(String s) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                for (int ii = 0; i < goodsArray.length(); i++) {
