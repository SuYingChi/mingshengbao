...
public class RatingBar extends LinearLayout {
    ...
    public void setStarHalfDrawable(Drawable starHalfDrawable) {
        this.starFillDrawable = starHalfDrawable;   ///?
    }
    ...
    public void emptyStar(boolean emptystart){this.emptystart=emptystart;} //新增
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        halfstart = mTypedArray.getBoolean(R.styleable.RatingBar_starFill, false); //?
