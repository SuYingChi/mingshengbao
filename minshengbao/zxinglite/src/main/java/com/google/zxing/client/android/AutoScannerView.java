...
public class AutoScannerView extends View {
    ...
    private final int triAngleColor = Color.parseColor("#F96331");                        //边角的颜色
...
//            canvas.drawLine(frame.left, frame.top + lineOffsetCount, frame.right, frame.top + lineOffsetCount, linePaint);    //画一条红色的线
            ...
            canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.drawable.scon_icon_scanline))).getBitmap(), null, lineRect, linePaint);
        }
